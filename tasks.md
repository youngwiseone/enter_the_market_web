...
- Mobile layout.
- Add tools (Watering Can (only watered crops grow/produce), Pickaxe (for mining tiles to make more land space), Gloves for selecting (default)
...
- Add profile icon to messages - change out depending on context (e.g. sundays show shop seller, thursday news paper man).
